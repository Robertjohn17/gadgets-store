...
function EditProductHeadphone() {
  const { headphone, setHeadphone } = useContext(MyContext);
  ...
  const handleSubmit = (e) => {
    ...
    const updatedHeadphone = headphone.map((product) =>
      product.Name === productedit.Name ? editedProduct : product
    );

    setHeadphone(updatedHeadphone);
    nav("/admin-headphone");
  };
...
export default EditProductHeadphone;
